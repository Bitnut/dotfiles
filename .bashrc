...
# export hostip=10.0.2.2
export https_proxy="http://${hostip}:8889"
export http_proxy="http://${hostip}:8889"
git config --global http.proxy "http://${hostip}:8889"
...
# eval "$(lua /home/picher/work/tools/zlua/z.lua --init bash enhanced once fzf)"
